...
<div class="form-group">
  ...
  <div class="col-md-6 col-sm-6 col-xs-12">
    <input type="text" readonly id="post-title" name="title" value="{{ $post->title }}" required="required" class="form-control col-md-7 col-xs-12">
...
<div class="form-group">
  ...
  <div class="col-md-6 col-sm-6 col-xs-12">
    <input type="text" readonly id="cat_name" name="cat_name"  value="{{ $post->cat_name }}"  required="required" class="form-control col-md-7 col-xs-12">
  </div>
</div>
...
<div class="col-md-6 col-sm-6 col-xs-12">
                          <div id="status" class="btn-group" data-toggle="buttons">
                            <label class="btn btn-primary" data-toggle-class="btn-primary" data-toggle-passive-class="btn-default">
                              <input readonly type="radio" name="status" <?php if($post->status == 'public') { ?>checked="checked" <?php } ?> value="public" data-parsley-multiple="status"> Public
                            </label>
                            <label class="btn btn-default" data-toggle-class="btn-primary" data-toggle-passive-class="btn-default">
                              <input readonly type="radio" name="status" <?php if($post->status == 'private') { ?>checked="checked" <?php } ?>  value="private" data-parsley-multiple="status"> Private
                            </label>
                          </div>
                        </div>
</div>
...
<div class="form-group">
  <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
    <a  type="primary" href="{{ route('admin-post-list') }}" class="btn btn-success">BACK TO LIST</a>
  </div>
</div>
